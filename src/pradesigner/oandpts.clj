...
oandpts provides endpts for oanda api

TODO
check routines and make more efficient when possible
also try to remember what they each do -> can be improved
"

(ns pradesigner.oandpts
  "endpts for oanda api"
  (:require [pradesigner.algolibs :refer [pip-factor]]
